...
export const DataContextProvider = ({ children }: DataContextProviderProps) => {
  ...
  _DataContext.addHandler({ ...subscribeHasAliveProcess, name: 'subscribeHasAliveProcess', relatedStores: ['requestState'], isStartImmediately: true });
